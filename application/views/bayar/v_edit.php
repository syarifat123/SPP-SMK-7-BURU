        ...
        <div class="clearfix"></div>
            <div class="row">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo base_url().'spp/update'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="date" id="jatuh_tempo" name="jatuh_tempo" required="required" class="form-control " value="<?= $data['jatuh_tempo'] ?>">
                                    <input type="hidden" id="id_spp" name="id_spp" required="required" class="form-control " value="<?= $data['id_spp'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="text" id="bulan_spp" name="bulan_spp" required="required" class="form-control " value="<?= $data['bulan_spp'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="number" id="no_bayar" name="no_bayar" required="required" class="form-control " value="<?= $data['no_bayar'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="date" id="tgl_bayar" name="tgl_bayar" required="required" class="form-control " value="<?= $data['tgl_bayar'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="number" id="jumlah_bayar" name="jumlah_bayar" required="required" class="form-control " value="<?= $data['jumlah_bayar'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="text" id="keterangan" name="keterangan" required="required" class="form-control " value="<?= $data['keterangan'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="text" id="status_bayar" name="status_bayar" required="required" class="form-control " value="<?= $data['status_bayar'] ?>">
                                </div>
                            </div>
