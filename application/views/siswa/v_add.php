        ...
        <div class="clearfix"></div>
            <div class="row">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo base_url().'siswa/insert'?>" method="post" class="form-horizontal form-label-left">

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">NISN<span class="required">*</span>
                                </label>
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="number" id="nisn_siswa" name="nisn_siswa" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <select id="id_kelas" name="id_kelas" required="required" class="form-control ">
                                        <option value="">- Pilih -</option>
                                        <?php $no=1; foreach($kelas as $row_kelas){?>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="Number" id="biaya_spp" name="biaya_spp" required="required" class="form-control ">
                                </div>
                            </div>
