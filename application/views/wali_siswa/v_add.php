        ...
        <div class="clearfix"></div>
            <div class="row">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo base_url().'wali_siswa/insert'?>" method="post" class="form-horizontal form-label-left">

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">NIK<span class="required">*</span>
                                </label>
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="text" id="nik_wali_siswa" name="nik_wali_siswa" required="required" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="text" id="nama_wali_siswa" name="nama_wali_siswa" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="text" id="alamat_wali_siswa" name="alamat_wali_siswa" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="number" id="nohp_wali_siswa" name="nohp_wali_siswa" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="email" id="email_wali_siswa" name="email_wali_siswa" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-12 ">
                                    <input type="password" id="password_wali_siswa" name="password_wali_siswa" required="required" class="form-control ">
                                </div>
                            </div>
